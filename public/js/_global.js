...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__popper__ = __webpack_require__(2);
...
var Tooltip = function ($) {
  ...
  var Tooltip = function () {
    function Tooltip(element, config) {
       ...
       */
      if (typeof __WEBPACK_IMPORTED_MODULE_1__popper___default.a === 'undefined') {
    ...
    _createClass(Tooltip, [{
      ...
      value: function show() {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          this._popper = new __WEBPACK_IMPORTED_MODULE_1__popper___default.a(this.element, tip, {
          ...
          if (__WEBPACK_IMPORTED_MODULE_2__util__["a" /* default */].supportsTransitionEnd() && $(this.tip).hasClass(ClassName.FADE)) {
            $(this.tip).one(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* default */].TRANSITION_END, complete).emulateTransitionEnd(Tooltip._TRANSITION_DURATION);
          } else {
            complete();
          }
        }
      ...
      value: function hide(callback) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__util__["a" /* default */].supportsTransitionEnd() && $(this.tip).hasClass(ClassName.FADE)) {
          $(tip).one(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* default */].TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
        } else {
          complete();
        }
  ...
  return Tooltip;
}(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a, __WEBPACK_IMPORTED_MODULE_1__popper___default.a);
...
window.jQuery = jquery = $ = __webpack_require__(6);

__webpack_require__(8);
//require('./src/index');

//window.TinyMCE = window.tinymce = require('./js/vendor/timymce');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__alert__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__button__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__carousel__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__collapse__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dropdown__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modal__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__popover__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__scrollspy__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tab__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tooltip__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__util__ = __webpack_require__(1);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Util", function() { return __WEBPACK_IMPORTED_MODULE_11__util__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Modal", function() { return __WEBPACK_IMPORTED_MODULE_6__modal__["a"]; });
  ...
  var Alert = function () {
    ...
    _createClass(Alert, [{
      ...
      value: function _removeElement(element) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].supportsTransitionEnd() || !$(element).hasClass(ClassName.FADE)) {
  ...
  var Carousel = function () {
    ...
    _createClass(Carousel, [{
      ...
      value: function pause(event) {
        ...
        if ($(this._element).find(Selector.NEXT_PREV)[0] && __WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].supportsTransitionEnd()) {
      ...
      value: function _slide(direction, element) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].supportsTransitionEnd() && $(this._element).hasClass(ClassName.SLIDE)) {
  ...
  var Collapse = function () {
    ...
    _createClass(Collapse, [{
      ...
      value: function show() {
        ...
        $(this._element).one(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
    ...
    _createClass(Dropdown, [{
      ...
      value: function toggle() {
        ...
        if (!this._inNavbar) {
          ...
          this._popper = new __WEBPACK_IMPORTED_MODULE_1__popper___default.a(element, this._menu, this._getPopperConfig());
        }
  ...
  var Modal = function () {
    ...
    _createClass(Modal, [{
      ...
      value: function _showElement(relatedTarget) {
        ...
        if (transition) {
          $(this._dialog).one(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].TRANSITION_END, transitionComplete).emulateTransitionEnd(TRANSITION_DURATION);
        } else {
          transitionComplete();
        }
      }
      ...
      value: function _showBackdrop(callback) {
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          $(this._backdrop).one(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].TRANSITION_END, callback).emulateTransitionEnd(BACKDROP_TRANSITION_DURATION);
          ...
          if (__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].supportsTransitionEnd() && $(this._element).hasClass(ClassName.FADE)) {
            $(this._backdrop).one(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].TRANSITION_END, callbackRemove).emulateTransitionEnd(BACKDROP_TRANSITION_DURATION);
          } else {
            callbackRemove();
          }
        } else if (callback) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tooltip__ = __webpack_require__(3);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
  ...
  var Tab = function () {
    ...
    _createClass(Tab, [{
      ...
      value: function _activate(element, container, callback) {
        ...
        var isTransitioning = callback && __WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].supportsTransitionEnd() && active && $(active).hasClass(ClassName.FADE);
        ...
        if (active && isTransitioning) {
          $(active).one(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* default */].TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
        } else {
          complete();
        }
      }
